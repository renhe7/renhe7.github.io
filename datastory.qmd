...
ggplot(data = newdf, aes(x = RelationshipNew, 
                      fill = Weapon)) +
  geom_bar(position = "fill") + labs(x = "Relationship between victim and murders", y = "Proportion", title = "Examining the influence of various relationships on the selection of weapons in homicides" )
```
